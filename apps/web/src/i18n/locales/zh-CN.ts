...
export const zhCN: Dict = {
  ...
  'launchpad.placeholder': '描述你想做的东西 —— 手机原型、演示文稿、海报…',
  'launchpad.heroBrand': 'Open Design',
  'launchpad.heroTagline': '一句话，设计一切。',
  'launchpad.tileMobile': '手机应用',
  'launchpad.tileWeb': 'Web 仪表盘',
  'launchpad.tileLanding': '落地页',
  'launchpad.tileDeck': '演示文稿',
  'launchpad.tileImage': '图片',
  'launchpad.tileVideo': '视频',
  'launchpad.tileAudio': '音频',
  'launchpad.tileConnector': '实时数据',
  'launchpad.tileHintMobile': '底部 Tab 导航 + 卡片流 + 主 CTA',
  'launchpad.tileHintWeb': '侧边栏 + 数据表格 + 状态卡片',
  'launchpad.tileHintLanding': 'Hero + 特性网格 + 注册 CTA',
  'launchpad.tileHintDeck': '10 页：愿景、问题、方案、诉求',
  'launchpad.tileHintImage': '品牌风格主视觉或插画',
  'launchpad.tileHintVideo': '5 秒动效短片，平滑揭示',
  'launchpad.tileHintAudio': '产品片头曲或人声 voice-over',
  'launchpad.tileHintConnector': '从已连接工具拉取实时指标',
  'launchpad.tileStarterMobile':
    '设计一个现代手机应用：底部 Tab 导航、卡片流 Feed、一个主要 CTA。配色简洁中性。',
  'launchpad.tileStarterWeb':
    '设计一个响应式 Web 管理后台：侧边栏导航、可排序的数据表格、顶部状态卡片。',
  'launchpad.tileStarterLanding':
    '设计一个现代产品落地页：Hero 模块、3 列特性网格、社会证据、注册 CTA。',
  'launchpad.tileStarterDeck':
    '生成一份 10 页产品概览演示稿，包含愿景、问题、方案、产品、增长数据、团队和诉求。',
  'launchpad.tileStarterImage':
    '生成一张主视觉插画：极简、品牌化、清晰的焦点主体、柔和的强调色。',
  'launchpad.tileStarterVideo':
    '生成一段 5 秒产品动效短片，平滑缓动，微妙揭示一项关键功能。',
  'launchpad.tileStarterAudio':
    '生成一段 10 秒积极向上的产品片头曲，现代且友好的音调。',
  'launchpad.tileStarterConnector':
    '构建一个看板：从已连接工具拉取实时数据，展示头部产品指标，包含状态头部和趋势图。',
  'launchpad.tileGoLabel': '启动',
  'launchpad.moreCapabilities': '想找灵感?',
  'launchpad.browseExamples': '浏览 50+ 模板技能',
  'launchpad.capPrototype': '原型',
  'launchpad.capArtifact': '产物',
  'launchpad.capDeck': '演示稿',
  'launchpad.capTemplate': '模板',
  'launchpad.capImage': '图片',
  'launchpad.capVideo': '视频',
  'launchpad.capAudio': '音频',
  'launchpad.formFactorLabel': '形态',
  'launchpad.formFactorMobile': '手机应用',
  'launchpad.formFactorWeb': 'Web 仪表盘',
  'launchpad.formFactorLanding': '落地页',
  'launchpad.fidelityLabel': '保真度',
  'launchpad.fidelityWireframe': '线框',
  'launchpad.fidelityHiFi': '高保真',
  'launchpad.tileStarterArtifact':
    '构建一个小型交互式 Web 产物：单一用途的工具，接受输入、处理后输出清晰且有用的结果。',
  'launchpad.tileStarterTemplate':
    '创建一个可复用的起始模板，供其他项目作为基础 —— 布局、组件集或带占位符的页面骨架。',
  'launchpad.settingsToggle': '设置',
  'launchpad.settingsEmpty': '已使用该能力的默认值。',
  'launchpad.settingsComingSoon': '该能力的更多选项即将推出。',
  'launchpad.examplesTitle': 'AI 能为你设计',
  'launchpad.examplesViewAll': '查看更多',
  'launchpad.exampleOpenLabel': '打开这个设计',
  'launchpad.exampleHabitName': '日常习惯追踪 App',
  'launchpad.exampleHabitPrompt':
    '设计一个简洁的移动端习惯追踪应用：5 个日常习惯加连续打卡计数、每周热力图、平静极简的配色。',
  'launchpad.exampleDashName': 'SaaS 营收驾驶舱',
  'launchpad.exampleDashPrompt':
    '设计一个 SaaS 管理后台：顶部 ARR/MRR 卡片、营收趋势图、可筛选与排序的客户表格。',
  'launchpad.exampleLandingName': 'AI 创业产品发布页',
  'launchpad.exampleLandingPrompt':
    '设计一个现代 AI 产品发布页：醒目动效的 Hero 标题、三栏特性网格、客户 logo 墙、注册 CTA。',
  'launchpad.exampleDeckName': 'A 轮融资演示稿',
  'launchpad.exampleDeckPrompt':
    '生成一份 12 页 A 轮融资演示稿：愿景、问题、市场、产品、增长数据、团队、诉求。编辑级排版，留白充足。',
  'launchpad.examplePosterName': '包豪斯品牌海报',
  'launchpad.examplePosterPrompt':
    '生成一张包豪斯风格的品牌海报：强烈的几何构图、三原色（红蓝黄）、有力的字体堆叠。',
  ...
  'launchpad.recentEmpty': '还没有项目 —— 选择上方一个起点，或直接描述你想做什么。',
  'launchpad.resume': '继续',
  'launchpad.create': '创建',
  'launchpad.attach': '添加',
  'launchpad.import': '导入',
  'launchpad.legacyToggle': '切换到旧版界面',
  'launchpad.legacyBadge': '旧版',
  'launchpad.modeBadge': 'Demo · Launchpad 信息架构',
