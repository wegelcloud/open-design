...
export const ptBR: Dict = {
  ...
  'liveArtifact.refresh.successOne': 'Atualização concluída. 1 bloco atualizado.',
  'liveArtifact.refresh.successMany': 'Atualização concluída. {count} blocos atualizados.',
