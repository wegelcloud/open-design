...
export const id: Dict = {
  ...
  'settings.testSuccessApi': 'Terhubung. Membalas dalam {ms} md — \'{sample}\'',
  'settings.testSuccessCli': '{agentName} membalas dalam {ms} md — \'{sample}\'',
  'settings.testAuthFailed': 'Autentikasi gagal. Periksa API key.',
  'settings.testForbidden': 'Akses ditolak. Verifikasi akun, region, atau organisasi.',
  'settings.testNotFoundModel': 'Model \'{model}\' tidak ditemukan di endpoint ini.',
  'settings.testInvalidModelId': 'ID model \'{model}\' tidak valid. ID kustom harus diawali huruf atau angka dan tanpa spasi.',
  'settings.testInvalidBaseUrl': 'Base URL tidak valid atau tidak dapat dijangkau.',
  'settings.testRateLimited': 'Provider membatasi laju tes. Konfigurasi terlihat valid.',
  'settings.testUpstream': 'Provider mengembalikan {status}. Coba lagi sebentar lagi.',
  'settings.testTimeout': 'Tes timeout setelah {ms} md.',
  'settings.testAgentMissing': '{agentName} belum terpasang atau tidak ada di PATH.',
  ...
  'sketch.close': 'Tutup',
  'sketch.textModalTitle': 'Tambahkan teks',
