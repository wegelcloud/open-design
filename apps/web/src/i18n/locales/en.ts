...
export const en: Dict = {
  ...
  'liveArtifact.refresh.noSourceTitle': 'No approved read-only refresh source is available yet.',
  ...
  'liveArtifact.refresh.successOne': 'Refresh complete. Updated 1 tile.',
  'liveArtifact.refresh.successMany': 'Refresh complete. Updated {count} tiles.',
