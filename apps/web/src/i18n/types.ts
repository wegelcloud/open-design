...
export interface Dict {
  ...
  // Launchpad (demo IA — center prompt + surface tiles + timeline)
  'launchpad.placeholder': string;
  'launchpad.heroBrand': string;
  'launchpad.heroTagline': string;
  'launchpad.tileMobile': string;
  'launchpad.tileWeb': string;
  'launchpad.tileLanding': string;
  'launchpad.tileDeck': string;
  'launchpad.tileImage': string;
  'launchpad.tileVideo': string;
  'launchpad.tileAudio': string;
  'launchpad.tileConnector': string;
  'launchpad.tileHintMobile': string;
  'launchpad.tileHintWeb': string;
  'launchpad.tileHintLanding': string;
  'launchpad.tileHintDeck': string;
  'launchpad.tileHintImage': string;
  'launchpad.tileHintVideo': string;
  'launchpad.tileHintAudio': string;
  'launchpad.tileHintConnector': string;
  'launchpad.tileStarterMobile': string;
  'launchpad.tileStarterWeb': string;
  'launchpad.tileStarterLanding': string;
  'launchpad.tileStarterDeck': string;
  'launchpad.tileStarterImage': string;
  'launchpad.tileStarterVideo': string;
  'launchpad.tileStarterAudio': string;
  'launchpad.tileStarterConnector': string;
  'launchpad.tileGoLabel': string;
  'launchpad.moreCapabilities': string;
  'launchpad.browseExamples': string;
  'launchpad.capPrototype': string;
  'launchpad.capArtifact': string;
  'launchpad.capDeck': string;
  'launchpad.capTemplate': string;
  'launchpad.capImage': string;
  'launchpad.capVideo': string;
  'launchpad.capAudio': string;
  'launchpad.formFactorLabel': string;
  'launchpad.formFactorMobile': string;
  'launchpad.formFactorWeb': string;
  'launchpad.formFactorLanding': string;
  'launchpad.fidelityLabel': string;
  'launchpad.fidelityWireframe': string;
  'launchpad.fidelityHiFi': string;
  'launchpad.tileStarterArtifact': string;
  'launchpad.tileStarterTemplate': string;
  'launchpad.settingsToggle': string;
  'launchpad.settingsEmpty': string;
  'launchpad.settingsComingSoon': string;
  'launchpad.examplesTitle': string;
  'launchpad.examplesViewAll': string;
  'launchpad.exampleOpenLabel': string;
  'launchpad.exampleHabitName': string;
  'launchpad.exampleHabitPrompt': string;
  'launchpad.exampleDashName': string;
  'launchpad.exampleDashPrompt': string;
  'launchpad.exampleLandingName': string;
  'launchpad.exampleLandingPrompt': string;
  'launchpad.exampleDeckName': string;
  'launchpad.exampleDeckPrompt': string;
  'launchpad.examplePosterName': string;
  ...
  'launchpad.recentEmpty': string;
  'launchpad.resume': string;
  'launchpad.create': string;
  'launchpad.attach': string;
  'launchpad.import': string;
  'launchpad.legacyToggle': string;
  'launchpad.legacyBadge': string;
  'launchpad.modeBadge': string;
