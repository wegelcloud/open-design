...
export function Icon({ name, size = 14, strokeWidth = 1.6, ...rest }: Props) {
  ...
  switch (name) {
    ...
    case 'home':
      // Filled house mark (RemixIcon-style) — overrides the default
      // stroke-based common props since the path is authored as a
      // filled silhouette rather than the line set the rest of this
      // sheet uses.
      return (
